/**
 * SortAscendingIcon 아이콘 컴포넌트
 * 자동 생성됨 - 수정하지 마세요
 */

import React, { type CSSProperties } from 'react';

export interface SortAscendingIconProps {
  size?: string | number;
  className?: string;
  color?: string;
  style?: CSSProperties;
...
const SortAscendingIcon: React.FC<SortAscendingIconProps> = ({
  size = 16,
  className,
  color,
  style,
