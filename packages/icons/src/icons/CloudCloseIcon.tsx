/**
 * CloudCloseIcon 아이콘 컴포넌트
 * 자동 생성됨 - 수정하지 마세요
 */

import React, { type CSSProperties } from 'react';

export interface CloudCloseIconProps {
  size?: string | number;
  className?: string;
  color?: string;
  style?: CSSProperties;
...
const CloudCloseIcon: React.FC<CloudCloseIconProps> = ({
  size = 16,
  className,
  color,
  style,
